...
****/
float Media(float valor1, float valor2){    // A função estava definida com parametros int, 
    float soma = valor1 + valor2;           // porém a media é calculada com valores reais,
    return soma / 2;                        // na parte main estava definido variaveis do tipo float                                    
}                                           // recebendo valores do tipo int, gerando imcopatibilidade e exibindo 8.0 e não 8.5
